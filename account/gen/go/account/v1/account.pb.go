...
const file_account_v1_account_proto_rawDesc = "" +
	...
	"\baccounts\x18\x01 \x03(\v2\x13.account.v1.AccountR\baccounts2\x83\x02\n" +
	"\x0eAccountService\x12P\n" +
	"\vPostAccount\x12\x1e.account.v1.PostAccountRequest\x1a\x1f.account.v1.PostAccountResponse\"\x00\x12M\n" +
	"\n" +
	"GetAccount\x12\x1d.account.v1.GetAccountRequest\x1a\x1e.account.v1.GetAccountResponse\"\x00\x12P\n" +
	"\vGetAccounts\x12\x1e.account.v1.GetAccountsRequest\x1a\x1f.account.v1.GetAccountsResponse\"\x00BFZDgithub.com/VivianRMS/go-ecommerce-micro/account/gen/go/account/v1;pbb\x06proto3"
