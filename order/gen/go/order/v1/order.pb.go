...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\border.v1\"\xb9\x02\n" +
	"\x05Order\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"created_at\x18\x02 \x01(\fR\tcreatedAt\x12\x1d\n" +
	"\n" +
	"account_id\x18\x03 \x01(\tR\taccountId\x12\x1f\n" +
	"\vtotal_price\x18\x04 \x01(\x01R\n" +
	"totalPrice\x128\n" +
	"\bproducts\x18\x05 \x03(\v2\x1c.order.v1.Order.OrderProductR\bproducts\x1a\x86\x01\n" +
	"\fOrderProduct\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x01R\x05price\x12\x1a\n" +
	"\bquantity\x18\x05 \x01(\rR\bquantity\"\xc1\x01\n" +
	"\x10PostOrderRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x02 \x01(\tR\taccountId\x12C\n" +
	"\bproducts\x18\x04 \x03(\v2'.order.v1.PostOrderRequest.OrderProductR\bproducts\x1aI\n" +
	...
	"\x06orders\x18\x01 \x03(\v2\x0f.order.v1.OrderR\x06orders2\xb8\x01\n" +
	"\fOrderService\x12D\n" +
	"\tPostOrder\x12\x1a.order.v1.PostOrderRequest\x1a\x1b.order.v1.PostOrderResponse\x12b\n" +
	"\x13GetOrdersForAccount\x12$.order.v1.GetOrdersForAccountRequest\x1a%.order.v1.GetOrdersForAccountResponseBBZ@github.com/VivianRMS/go-ecommerce-micro/order/gen/go/order/v1;pbb\x06proto3"
...
var file_order_v1_order_proto_goTypes = []any{
	...
	(*PostOrderRequest)(nil),              // 1: order.v1.PostOrderRequest
	(*PostOrderResponse)(nil),             // 2: order.v1.PostOrderResponse
	(*GetOrderRequest)(nil),               // 3: order.v1.GetOrderRequest
	(*GetOrderResponse)(nil),              // 4: order.v1.GetOrderResponse
	(*GetOrdersForAccountRequest)(nil),    // 5: order.v1.GetOrdersForAccountRequest
	(*GetOrdersForAccountResponse)(nil),   // 6: order.v1.GetOrdersForAccountResponse
	(*Order_OrderProduct)(nil),            // 7: order.v1.Order.OrderProduct
	(*PostOrderRequest_OrderProduct)(nil), // 8: order.v1.PostOrderRequest.OrderProduct
}
var file_order_v1_order_proto_depIdxs = []int32{
	7, // 0: order.v1.Order.products:type_name -> order.v1.Order.OrderProduct
	8, // 1: order.v1.PostOrderRequest.products:type_name -> order.v1.PostOrderRequest.OrderProduct
	0, // 2: order.v1.PostOrderResponse.order:type_name -> order.v1.Order
	0, // 3: order.v1.GetOrderResponse.order:type_name -> order.v1.Order
	0, // 4: order.v1.GetOrdersForAccountResponse.orders:type_name -> order.v1.Order
	1, // 5: order.v1.OrderService.PostOrder:input_type -> order.v1.PostOrderRequest
	5, // 6: order.v1.OrderService.GetOrdersForAccount:input_type -> order.v1.GetOrdersForAccountRequest
	2, // 7: order.v1.OrderService.PostOrder:output_type -> order.v1.PostOrderResponse
	6, // 8: order.v1.OrderService.GetOrdersForAccount:output_type -> order.v1.GetOrdersForAccountResponse
