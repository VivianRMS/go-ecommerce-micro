...
const (
	OrderService_PostOrder_FullMethodName           = "/order.v1.OrderService/PostOrder"
	OrderService_GetOrdersForAccount_FullMethodName = "/order.v1.OrderService/GetOrdersForAccount"
)
